...
export const testinmonials = [
  {
    id: 0,
    name: "Walter Davidson",
    quote: `“ When I first starting using PCT I didn't have their machines, but their dimer was still compatiable with the machine I had at the time and STILL HAD AMAZING RESULTS! I now use both their machines and dimer, wish I would've started with their equipment - it's just so easy to use." `,
    image: "/images/testimonial_1.png",
  },
  {
    id: 1,
    name: "Kathleen Meyer",
    quote: `“ I almost didn’t believe the quality of this product the first couple times using it. It still blows mey away, recommend it to all fellow businesses that need to coat in house. “ `,
    image: "/images/testimonial_2.png",
  },
  {
    id: 2,
    name: "Cline Labs",
    quote: `“ We have been working with Paracoat since 2013. Over the last 8 years Paracoat has gone above and beyond to meet requested and expedited ship date. There quality is excellent as well as their on time deliveries. I highly recommend them for any customers who have needs for Parylene coating.“`,
